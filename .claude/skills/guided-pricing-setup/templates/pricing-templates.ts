/**
 * Starter templates for the product creation wizard.
 * Used by the template-gallery component to pre-fill the wizard.
 */
...
export const PRICING_TEMPLATES: PricingTemplate[] = [
  ...
  },
  {
    ...
    icon: '📊',
    title: 'Usage-Based',
    description: '$X per unit of consumption (API calls, records, etc.)',
    defaults: {
      productType: 'subscription',
      chargeType: 'usage',
      billingFrequency: 'monthly',
  ...
  },
  {
    ...
    icon: '📦',
    title: 'Flat Rate',
    description: 'Simple recurring charge — one price for all',
    defaults: {
      productType: 'subscription',
      chargeType: 'recurring',
      billingFrequency: 'monthly',
  ...
  },
  {
    ...
    icon: '📈',
    title: 'Tiered Volume',
    description: 'Quantity-based tiers — lower unit price at higher volumes',
    defaults: {
      productType: 'subscription',
      chargeType: 'recurring',
  ...
  },
  {
    ...
    icon: '🔧',
    title: 'One-Time Fee',
    description: 'Implementation, setup, or configuration charge',
    defaults: {
  ...
  },
  {
    ...
    description: 'Consulting, training, or data migration — hourly or project',
    defaults: {
